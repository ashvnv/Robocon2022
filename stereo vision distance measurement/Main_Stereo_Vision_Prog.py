...
for i in range(0,13):   # Put the amount of pictures you have taken for the calibration inbetween range(0,?) wenn starting from the image number 0
    t= str(i)
    ChessImaR= cv2.imread('chessboard-R'+t+'.png')    # Right side
    ChessImaL= cv2.imread('chessboard-L'+t+'.png')    # Left side
    ...
    hsv = cv2.cvtColor(ChessImaR, cv2.COLOR_BGR2HSV)
